...
namespace commercetools.Sdk.Api.Client.RequestBuilders.PaymentMethods
{
    ...
    public partial class ByProjectKeyPaymentMethodsKeyByKeyPost : ApiMethod<ByProjectKeyPaymentMethodsKeyByKeyPost>, IApiMethod<ByProjectKeyPaymentMethodsKeyByKeyPost, commercetools.Sdk.Api.Models.PaymentMethods.IPaymentMethod>, commercetools.Sdk.Api.Client.IConflictingTrait<ByProjectKeyPaymentMethodsKeyByKeyPost>, commercetools.Sdk.Api.Client.IExpandableTrait<ByProjectKeyPaymentMethodsKeyByKeyPost>, commercetools.Sdk.Api.Client.IDeprecatable200Trait<ByProjectKeyPaymentMethodsKeyByKeyPost>, commercetools.Sdk.Api.Client.IErrorableTrait<ByProjectKeyPaymentMethodsKeyByKeyPost>
    {
        ...
        public ByProjectKeyPaymentMethodsKeyByKeyPost(IClient apiHttpClient, ISerializerService serializerService, string projectKey, string key, commercetools.Sdk.Api.Models.PaymentMethods.IPaymentMethodUpdate paymentMethodUpdate)
        {
        ...
        public ByProjectKeyPaymentMethodsKeyByKeyPost WithExpand(string expand)
        {
