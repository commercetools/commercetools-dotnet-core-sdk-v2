...
namespace commercetools.Sdk.Api.Client.RequestBuilders.McpServers
{
    ...
    public partial class ByProjectKeyMcpServersByIDPost : ApiMethod<ByProjectKeyMcpServersByIDPost>, IApiMethod<ByProjectKeyMcpServersByIDPost, commercetools.Sdk.Api.Models.McpServers.IMcpServer>, commercetools.Sdk.Api.Client.IConflictingTrait<ByProjectKeyMcpServersByIDPost>, commercetools.Sdk.Api.Client.IErrorableTrait<ByProjectKeyMcpServersByIDPost>
    {
        ...
        public ByProjectKeyMcpServersByIDPost(IClient apiHttpClient, ISerializerService serializerService, string projectKey, string id, commercetools.Sdk.Api.Models.McpServers.IMcpServerUpdate mcpServerUpdate)
        {
