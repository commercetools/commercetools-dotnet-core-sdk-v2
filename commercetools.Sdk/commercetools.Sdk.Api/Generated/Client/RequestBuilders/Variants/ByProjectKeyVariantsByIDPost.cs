...
namespace commercetools.Sdk.Api.Client.RequestBuilders.Variants
{
    ...
    public partial class ByProjectKeyVariantsByIDPost : ApiMethod<ByProjectKeyVariantsByIDPost>, IApiMethod<ByProjectKeyVariantsByIDPost, commercetools.Sdk.Api.Models.Variants.IVariant>, commercetools.Sdk.Api.Client.IConflictingTrait<ByProjectKeyVariantsByIDPost>, commercetools.Sdk.Api.Client.IExpandableTrait<ByProjectKeyVariantsByIDPost>, commercetools.Sdk.Api.Client.IDeprecatable200Trait<ByProjectKeyVariantsByIDPost>, commercetools.Sdk.Api.Client.IErrorableTrait<ByProjectKeyVariantsByIDPost>
    {
        ...
        public ByProjectKeyVariantsByIDPost(IClient apiHttpClient, ISerializerService serializerService, string projectKey, string id, commercetools.Sdk.Api.Models.Variants.IVariantUpdate variantUpdate)
        {
        ...
        public ByProjectKeyVariantsByIDPost WithExpand(string expand)
        {
