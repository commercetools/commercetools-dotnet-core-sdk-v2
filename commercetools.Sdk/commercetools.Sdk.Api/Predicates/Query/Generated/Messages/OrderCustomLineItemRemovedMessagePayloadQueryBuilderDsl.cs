...
namespace commercetools.Sdk.Api.Predicates.Query.Messages
{
    ...
    public partial class OrderCustomLineItemRemovedMessagePayloadQueryBuilderDsl
    {
        ...
        public IComparisonPredicateBuilder<OrderCustomLineItemRemovedMessagePayloadQueryBuilderDsl, string> CustomLineItemKey()
        {
            return new ComparisonPredicateBuilder<OrderCustomLineItemRemovedMessagePayloadQueryBuilderDsl, string>(BinaryQueryPredicate.Of().Left(new ConstantQueryPredicate("customLineItemKey")),
            p => new CombinationQueryPredicate<OrderCustomLineItemRemovedMessagePayloadQueryBuilderDsl>(p, OrderCustomLineItemRemovedMessagePayloadQueryBuilderDsl.Of),
            PredicateFormatter.Format);
        }
