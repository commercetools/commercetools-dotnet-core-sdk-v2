...
namespace commercetools.Sdk.Api.Predicates.Query.BusinessUnits
{
    ...
    public partial class DivisionQueryBuilderDsl
    {
        ...
        public CombinationQueryPredicate<DivisionQueryBuilderDsl> InheritedStores(
            Func<commercetools.Sdk.Api.Predicates.Query.Stores.StoreKeyReferenceQueryBuilderDsl, CombinationQueryPredicate<commercetools.Sdk.Api.Predicates.Query.Stores.StoreKeyReferenceQueryBuilderDsl>> fn)
        {
            return new CombinationQueryPredicate<DivisionQueryBuilderDsl>(ContainerQueryPredicate.Of()
        ...
        public ICollectionPredicateBuilder<DivisionQueryBuilderDsl> InheritedStores()
        {
            return new CollectionPredicateBuilder<DivisionQueryBuilderDsl>(BinaryQueryPredicate.Of().Left(new ConstantQueryPredicate("inheritedStores")),
                    p => new CombinationQueryPredicate<DivisionQueryBuilderDsl>(p, DivisionQueryBuilderDsl.Of));
        }
        ...
        public ICollectionPredicateBuilder<DivisionQueryBuilderDsl> CustomerGroupAssignments()
        {
            return new CollectionPredicateBuilder<DivisionQueryBuilderDsl>(BinaryQueryPredicate.Of().Left(new ConstantQueryPredicate("customerGroupAssignments")),
                    p => new CombinationQueryPredicate<DivisionQueryBuilderDsl>(p, DivisionQueryBuilderDsl.Of));
        }
        ...
        public IComparisonPredicateBuilder<DivisionQueryBuilderDsl, string> ApprovalRuleMode()
        {
            return new ComparisonPredicateBuilder<DivisionQueryBuilderDsl, string>(BinaryQueryPredicate.Of().Left(new ConstantQueryPredicate("approvalRuleMode")),
            p => new CombinationQueryPredicate<DivisionQueryBuilderDsl>(p, DivisionQueryBuilderDsl.Of),
            PredicateFormatter.Format);
        }
