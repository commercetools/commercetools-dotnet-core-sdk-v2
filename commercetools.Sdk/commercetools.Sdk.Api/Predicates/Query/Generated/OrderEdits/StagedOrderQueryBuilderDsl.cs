...
namespace commercetools.Sdk.Api.Predicates.Query.OrderEdits
{
    ...
    public partial class StagedOrderQueryBuilderDsl
    {
        ...
        public IComparisonPredicateBuilder<StagedOrderQueryBuilderDsl, string> PriceRoundingMode()
        {
            return new ComparisonPredicateBuilder<StagedOrderQueryBuilderDsl, string>(BinaryQueryPredicate.Of().Left(new ConstantQueryPredicate("priceRoundingMode")),
            p => new CombinationQueryPredicate<StagedOrderQueryBuilderDsl>(p, StagedOrderQueryBuilderDsl.Of),
            PredicateFormatter.Format);
        }
        ...
        public IComparisonPredicateBuilder<StagedOrderQueryBuilderDsl, bool> DirectDiscountsIgnoreCartDiscounts()
        {
            return new ComparisonPredicateBuilder<StagedOrderQueryBuilderDsl, bool>(BinaryQueryPredicate.Of().Left(new ConstantQueryPredicate("directDiscountsIgnoreCartDiscounts")),
            p => new CombinationQueryPredicate<StagedOrderQueryBuilderDsl>(p, StagedOrderQueryBuilderDsl.Of),
            PredicateFormatter.Format);
        }
        ...
        public CombinationQueryPredicate<StagedOrderQueryBuilderDsl> RecurringOrder(
