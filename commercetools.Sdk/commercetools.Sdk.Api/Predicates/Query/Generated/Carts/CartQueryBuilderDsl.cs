...
namespace commercetools.Sdk.Api.Predicates.Query.Carts
{
    ...
    public partial class CartQueryBuilderDsl
    {
        ...
        public IComparisonPredicateBuilder<CartQueryBuilderDsl, string> PriceRoundingMode()
        {
            return new ComparisonPredicateBuilder<CartQueryBuilderDsl, string>(BinaryQueryPredicate.Of().Left(new ConstantQueryPredicate("priceRoundingMode")),
            p => new CombinationQueryPredicate<CartQueryBuilderDsl>(p, CartQueryBuilderDsl.Of),
            PredicateFormatter.Format);
        }
        ...
        public IComparisonPredicateBuilder<CartQueryBuilderDsl, bool> DirectDiscountsIgnoreCartDiscounts()
        {
            return new ComparisonPredicateBuilder<CartQueryBuilderDsl, bool>(BinaryQueryPredicate.Of().Left(new ConstantQueryPredicate("directDiscountsIgnoreCartDiscounts")),
            p => new CombinationQueryPredicate<CartQueryBuilderDsl>(p, CartQueryBuilderDsl.Of),
            PredicateFormatter.Format);
        }
        ...
        public IComparisonPredicateBuilder<CartQueryBuilderDsl, string> PurchaseOrderNumber()
        {
            return new ComparisonPredicateBuilder<CartQueryBuilderDsl, string>(BinaryQueryPredicate.Of().Left(new ConstantQueryPredicate("purchaseOrderNumber")),
            p => new CombinationQueryPredicate<CartQueryBuilderDsl>(p, CartQueryBuilderDsl.Of),
            PredicateFormatter.Format);
        }
