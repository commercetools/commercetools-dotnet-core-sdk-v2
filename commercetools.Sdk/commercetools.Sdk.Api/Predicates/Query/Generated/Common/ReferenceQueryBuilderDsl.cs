...
namespace commercetools.Sdk.Api.Predicates.Query.Common
{
    ...
    public partial class ReferenceQueryBuilderDsl
    {
        ...
        {
            return new CombinationQueryPredicate<ReferenceQueryBuilderDsl>(fn.Invoke(commercetools.Sdk.Api.Predicates.Query.RecurrencePolicies.RecurrencePolicyReferenceQueryBuilderDsl.Of()),
                ReferenceQueryBuilderDsl.Of);
        }
        ...
        {
            return new CombinationQueryPredicate<ReferenceQueryBuilderDsl>(fn.Invoke(commercetools.Sdk.Api.Predicates.Query.Variants.VariantReferenceQueryBuilderDsl.Of()),
                ReferenceQueryBuilderDsl.Of);
        }
