...
namespace commercetools.Sdk.Api.Predicates.Query.Errors
{
    ...
    public partial class GraphQLErrorObjectQueryBuilderDsl
    {
        ...
        public CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl> AsBulkOperationMaxItemsExceeded(
            Func<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLBulkOperationMaxItemsExceededErrorQueryBuilderDsl, CombinationQueryPredicate<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLBulkOperationMaxItemsExceededErrorQueryBuilderDsl>> fn)
        {
        ...
        public CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl> AsExactLockConflict(
            Func<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLExactLockConflictErrorQueryBuilderDsl, CombinationQueryPredicate<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLExactLockConflictErrorQueryBuilderDsl>> fn)
        {
            return new CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl>(fn.Invoke(commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLExactLockConflictErrorQueryBuilderDsl.Of()),
                GraphQLErrorObjectQueryBuilderDsl.Of);
        }
        ...
        public CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl> AsExtensionChainTooDeep(
            Func<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLExtensionChainTooDeepErrorQueryBuilderDsl, CombinationQueryPredicate<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLExtensionChainTooDeepErrorQueryBuilderDsl>> fn)
        {
            return new CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl>(fn.Invoke(commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLExtensionChainTooDeepErrorQueryBuilderDsl.Of()),
                GraphQLErrorObjectQueryBuilderDsl.Of);
        }
        ...
        public CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl> AsExtensionDependencyExists(
            Func<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLExtensionDependencyExistsErrorQueryBuilderDsl, CombinationQueryPredicate<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLExtensionDependencyExistsErrorQueryBuilderDsl>> fn)
        {
            return new CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl>(fn.Invoke(commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLExtensionDependencyExistsErrorQueryBuilderDsl.Of()),
                GraphQLErrorObjectQueryBuilderDsl.Of);
        }
        ...
        public CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl> AsLineItemQuantityAboveLimit(
            Func<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLLineItemQuantityAboveLimitErrorQueryBuilderDsl, CombinationQueryPredicate<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLLineItemQuantityAboveLimitErrorQueryBuilderDsl>> fn)
        {
            return new CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl>(fn.Invoke(commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLLineItemQuantityAboveLimitErrorQueryBuilderDsl.Of()),
                GraphQLErrorObjectQueryBuilderDsl.Of);
        }
        public CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl> AsLineItemQuantityBelowLimit(
            Func<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLLineItemQuantityBelowLimitErrorQueryBuilderDsl, CombinationQueryPredicate<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLLineItemQuantityBelowLimitErrorQueryBuilderDsl>> fn)
        {
            return new CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl>(fn.Invoke(commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLLineItemQuantityBelowLimitErrorQueryBuilderDsl.Of()),
                GraphQLErrorObjectQueryBuilderDsl.Of);
        }
        ...
        public CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl> AsMaxDiscountGroupsReached(
            Func<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLMaxDiscountGroupsReachedErrorQueryBuilderDsl, CombinationQueryPredicate<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLMaxDiscountGroupsReachedErrorQueryBuilderDsl>> fn)
        {
            return new CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl>(fn.Invoke(commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLMaxDiscountGroupsReachedErrorQueryBuilderDsl.Of()),
                GraphQLErrorObjectQueryBuilderDsl.Of);
        }
        ...
        public CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl> AsRecurringOrderFailure(
            Func<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLRecurringOrderFailureErrorQueryBuilderDsl, CombinationQueryPredicate<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLRecurringOrderFailureErrorQueryBuilderDsl>> fn)
        {
            return new CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl>(fn.Invoke(commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLRecurringOrderFailureErrorQueryBuilderDsl.Of()),
                GraphQLErrorObjectQueryBuilderDsl.Of);
        }
        ...
        public CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl> AsSearchNotReady(
            Func<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLSearchNotReadyErrorQueryBuilderDsl, CombinationQueryPredicate<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLSearchNotReadyErrorQueryBuilderDsl>> fn)
        {
            return new CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl>(fn.Invoke(commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLSearchNotReadyErrorQueryBuilderDsl.Of()),
                GraphQLErrorObjectQueryBuilderDsl.Of);
        }
        ...
        public CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl> AsUnauthorized(
            Func<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLUnauthorizedErrorQueryBuilderDsl, CombinationQueryPredicate<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLUnauthorizedErrorQueryBuilderDsl>> fn)
        {
            return new CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl>(fn.Invoke(commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLUnauthorizedErrorQueryBuilderDsl.Of()),
                GraphQLErrorObjectQueryBuilderDsl.Of);
        }
        public CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl> AsValidityLockConflict(
            Func<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLValidityLockConflictErrorQueryBuilderDsl, CombinationQueryPredicate<commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLValidityLockConflictErrorQueryBuilderDsl>> fn)
        {
            return new CombinationQueryPredicate<GraphQLErrorObjectQueryBuilderDsl>(fn.Invoke(commercetools.Sdk.Api.Predicates.Query.Errors.GraphQLValidityLockConflictErrorQueryBuilderDsl.Of()),
                GraphQLErrorObjectQueryBuilderDsl.Of);
        }
    }
}
