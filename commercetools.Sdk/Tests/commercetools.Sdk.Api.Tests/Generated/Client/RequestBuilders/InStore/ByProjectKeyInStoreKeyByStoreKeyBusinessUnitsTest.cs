...
{
    public class ByProjectKeyInStoreKeyByStoreKeyBusinessUnitsTest : RequestBuilderParentTests
    {
        [Theory]
        ...
        public static IEnumerable<object[]> GetData()
        {
            return new List<object[]> {
               ...
               new Object[] {
                   ...
                   .Build(),
                   "Get",
                   "/test_projectKey/in-store/key=test_storeKey/business-units?limit=7",
               },
               new Object[] {
                   ApiRoot
                   .WithProjectKey("test_projectKey")
                   ...
                   .Build(),
                   "Get",
                   "/test_projectKey/in-store/key=test_storeKey/business-units?offset=3",
               },
               new Object[] {
                   ApiRoot
                   .WithProjectKey("test_projectKey")
                   ...
                   .Build(),
                   "Get",
                   "/test_projectKey/in-store/key=test_storeKey/business-units?withTotal=true",
               },
               new Object[] {
                   ApiRoot
                   .WithProjectKey("test_projectKey")
