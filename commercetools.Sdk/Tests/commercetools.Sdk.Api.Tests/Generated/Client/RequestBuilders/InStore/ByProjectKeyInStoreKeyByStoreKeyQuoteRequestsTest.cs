...
{
    public class ByProjectKeyInStoreKeyByStoreKeyQuoteRequestsTest : RequestBuilderParentTests
    {
        [Theory]
        ...
        public static IEnumerable<object[]> GetData()
        {
            return new List<object[]> {
               ...
               new Object[] {
                   ...
                   .Build(),
                   "Get",
                   "/test_projectKey/in-store/key=test_storeKey/quote-requests?limit=7",
               },
               new Object[] {
                   ApiRoot
                   .WithProjectKey("test_projectKey")
                   ...
                   .Build(),
                   "Get",
                   "/test_projectKey/in-store/key=test_storeKey/quote-requests?offset=3",
               },
               new Object[] {
                   ApiRoot
                   .WithProjectKey("test_projectKey")
                   ...
                   .Build(),
                   "Get",
                   "/test_projectKey/in-store/key=test_storeKey/quote-requests?withTotal=true",
               },
               new Object[] {
                   ApiRoot
                   .WithProjectKey("test_projectKey")
