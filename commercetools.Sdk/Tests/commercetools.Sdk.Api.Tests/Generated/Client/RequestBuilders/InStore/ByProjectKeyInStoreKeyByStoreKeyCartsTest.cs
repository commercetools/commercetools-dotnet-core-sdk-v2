...
{
    public class ByProjectKeyInStoreKeyByStoreKeyCartsTest:RequestBuilderParentTests 
   { 
       [Theory]
       ...
       return new List<object[]> {
               ...
               new Object[] {           
                   ...
                   .Build(),
                   "Get",
                   "/test_projectKey/in-store/key=test_storeKey/carts?limit=7",
               },
               new Object[] {           
                   ApiRoot
                   .WithProjectKey("test_projectKey")
                   ...
                   .Build(),
                   "Get",
                   "/test_projectKey/in-store/key=test_storeKey/carts?offset=3",
               },
               new Object[] {           
                   ApiRoot
                   .WithProjectKey("test_projectKey")
