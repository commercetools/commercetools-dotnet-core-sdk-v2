...
{
    public class ByProjectKeyInStoreKeyByStoreKeyOrdersByIDTest : RequestBuilderParentTests
    {
        [Theory]
        ...
        public static IEnumerable<object[]> GetData()
        {
            return new List<object[]> {
               ...
               new Object[] {
                   ...
                   .Build(),
                   "Delete",
                   "/test_projectKey/in-store/key=test_storeKey/orders/test_ID?dataErasure=true",
               },
               new Object[] {
                   ApiRoot
                   .WithProjectKey("test_projectKey")
