...
{
    public class ByProjectKeyInStoreKeyByStoreKeyVariantProjectionsKeyByKeyTest : RequestBuilderParentTests
    {
        [Theory]
        ...
        public static IEnumerable<object[]> GetData()
        {
            return new List<object[]> {
               new Object[] {
                   ...
                   .Build(),
                   "Get",
                   "/test_projectKey/in-store/key=test_storeKey/variant-projections/key=test_key?staged=true",
               },
               new Object[] {
                   ApiRoot
                   .WithProjectKey("test_projectKey")
               ...
               new Object[] {
                   ...
                   .Build(),
                   "Get",
                   "/test_projectKey/in-store/key=test_storeKey/variant-projections/key=test_key?filter[attributes]=filter%5Battributes%5D",
               },
               new Object[] {
                   ApiRoot
                   .WithProjectKey("test_projectKey")
