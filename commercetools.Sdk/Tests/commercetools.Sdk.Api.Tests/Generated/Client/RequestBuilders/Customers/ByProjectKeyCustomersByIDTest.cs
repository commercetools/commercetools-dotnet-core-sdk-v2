...
{
   public class ByProjectKeyCustomersByIDTest:RequestBuilderParentTests 
   { 
       [Theory]
       ...
       return new List<object[]> {
               ...
               new Object[] {           
                   ...
                   .Build(),
                   "Delete",
                   "/test_projectKey/customers/test_ID?dataErasure=true",
               },
               new Object[] {           
                   ApiRoot
                   .WithProjectKey("test_projectKey")
                   ...
                   .Build(),
                   "Delete",
                   "/test_projectKey/customers/test_ID?version=2",
               },
               new Object[] {           
                   ApiRoot
                   .WithProjectKey("test_projectKey")
