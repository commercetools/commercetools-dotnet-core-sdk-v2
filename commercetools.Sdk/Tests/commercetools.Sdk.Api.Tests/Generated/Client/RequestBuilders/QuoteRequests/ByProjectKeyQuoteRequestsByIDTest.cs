...
{
    public class ByProjectKeyQuoteRequestsByIDTest : RequestBuilderParentTests
    {
        [Theory]
        ...
        public static IEnumerable<object[]> GetData()
        {
            return new List<object[]> {
               ...
               new Object[] {
                   ...
                   .Build(),
                   "Delete",
                   "/test_projectKey/quote-requests/test_ID?dataErasure=true",
               },
               new Object[] {
                   ApiRoot
                   .WithProjectKey("test_projectKey")
                   ...
                   .Build(),
                   "Delete",
                   "/test_projectKey/quote-requests/test_ID?version=2",
               },
               new Object[] {
                   ApiRoot
                   .WithProjectKey("test_projectKey")
