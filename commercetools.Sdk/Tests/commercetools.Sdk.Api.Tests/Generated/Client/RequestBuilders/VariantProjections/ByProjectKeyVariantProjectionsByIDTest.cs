...
{
    public class ByProjectKeyVariantProjectionsByIDTest : RequestBuilderParentTests
    {
        [Theory]
        ...
        public static IEnumerable<object[]> GetData()
        {
            return new List<object[]> {
               new Object[] {
                   ...
                   .Build(),
                   "Get",
                   "/test_projectKey/variant-projections/test_ID?staged=true",
               },
               new Object[] {
                   ApiRoot
                   .WithProjectKey("test_projectKey")
               ...
               new Object[] {
                   ...
                   .Build(),
                   "Get",
                   "/test_projectKey/variant-projections/test_ID?filter[attributes]=filter%5Battributes%5D",
               },
               new Object[] {
                   ApiRoot
                   .WithProjectKey("test_projectKey")
