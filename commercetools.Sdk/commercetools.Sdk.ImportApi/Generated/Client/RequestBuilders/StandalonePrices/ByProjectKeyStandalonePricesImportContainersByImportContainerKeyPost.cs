...
namespace commercetools.Sdk.ImportApi.Client.RequestBuilders.StandalonePrices
{
    ...
    public partial class ByProjectKeyStandalonePricesImportContainersByImportContainerKeyPost : ApiMethod<ByProjectKeyStandalonePricesImportContainersByImportContainerKeyPost>, IApiMethod<ByProjectKeyStandalonePricesImportContainersByImportContainerKeyPost, commercetools.Sdk.ImportApi.Models.Importrequests.IImportResponse>, commercetools.Sdk.ImportApi.Client.ISecured_by_manage_standalone_pricesTrait<ByProjectKeyStandalonePricesImportContainersByImportContainerKeyPost>
    {
        ...
        private commercetools.Sdk.ImportApi.Models.Importrequests.IStandalonePriceImportRequest StandalonePriceImportRequest;

        public ByProjectKeyStandalonePricesImportContainersByImportContainerKeyPost(IClient apiHttpClient, ISerializerService serializerService, string projectKey, string importContainerKey, commercetools.Sdk.ImportApi.Models.Importrequests.IStandalonePriceImportRequest standalonePriceImportRequest)
        {
        ...
        public override HttpRequestMessage Build()
        {
            ...
            {
                var body = this.SerializerService.Serialize(StandalonePriceImportRequest);
