...
namespace commercetools.Sdk.CheckoutApi.Client.RequestBuilders.PaymentIntegrations
{
    ...
    public partial class ByProjectKeyPaymentIntegrationsKeyByKeyPost : ApiMethod<ByProjectKeyPaymentIntegrationsKeyByKeyPost>, IApiMethod<ByProjectKeyPaymentIntegrationsKeyByKeyPost, commercetools.Sdk.CheckoutApi.Models.PaymentIntegrations.IPaymentIntegration>, commercetools.Sdk.CheckoutApi.Client.ISecured_by_manage_payment_integrationsTrait<ByProjectKeyPaymentIntegrationsKeyByKeyPost>
    {
        ...
        private commercetools.Sdk.CheckoutApi.Models.PaymentIntegrations.IPaymentIntegrationUpdateActions PaymentIntegrationUpdateActions;

        public ByProjectKeyPaymentIntegrationsKeyByKeyPost(IClient apiHttpClient, ISerializerService serializerService, string projectKey, string key, commercetools.Sdk.CheckoutApi.Models.PaymentIntegrations.IPaymentIntegrationUpdateActions paymentIntegrationUpdateActions)
        {
        ...
        public override HttpRequestMessage Build()
        {
            ...
            {
                var body = this.SerializerService.Serialize(PaymentIntegrationUpdateActions);
