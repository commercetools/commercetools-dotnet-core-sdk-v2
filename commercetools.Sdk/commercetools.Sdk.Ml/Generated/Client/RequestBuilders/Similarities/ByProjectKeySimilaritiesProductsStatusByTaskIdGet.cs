...
namespace commercetools.Ml.Client.RequestBuilders.Similarities
{
   public partial class ByProjectKeySimilaritiesProductsStatusByTaskIdGet : ApiMethod<ByProjectKeySimilaritiesProductsStatusByTaskIdGet> {
       ...
       public async Task<commercetools.Ml.Models.SimilarProducts.SimilarProductsTaskStatus> ExecuteAsync()
       {
          var requestMessage = Build();
          return await ApiHttpClient.ExecuteAsync<commercetools.Ml.Models.SimilarProducts.SimilarProductsTaskStatus>(requestMessage);
       }
   }
}
