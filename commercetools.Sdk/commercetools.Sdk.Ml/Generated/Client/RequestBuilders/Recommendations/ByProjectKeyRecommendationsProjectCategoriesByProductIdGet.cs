...
namespace commercetools.Ml.Client.RequestBuilders.Recommendations
{
   public partial class ByProjectKeyRecommendationsProjectCategoriesByProductIdGet : ApiMethod<ByProjectKeyRecommendationsProjectCategoriesByProductIdGet> {
       ...
       public async Task<commercetools.Ml.Models.CategoryRecommendations.ProjectCategoryRecommendationPagedQueryResponse> ExecuteAsync()
       {
          var requestMessage = Build();
          return await ApiHttpClient.ExecuteAsync<commercetools.Ml.Models.CategoryRecommendations.ProjectCategoryRecommendationPagedQueryResponse>(requestMessage);
       }
   }
}
