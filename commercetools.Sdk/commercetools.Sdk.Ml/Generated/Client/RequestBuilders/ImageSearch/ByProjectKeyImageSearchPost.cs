...
namespace commercetools.Ml.Client.RequestBuilders.ImageSearch
{
   public partial class ByProjectKeyImageSearchPost : ApiMethod<ByProjectKeyImageSearchPost> {
       ...
       public async Task<commercetools.Ml.Models.ImageSearches.ImageSearchResponse> ExecuteAsync()
       {
          var requestMessage = Build();
          return await ApiHttpClient.ExecuteAsync<commercetools.Ml.Models.ImageSearches.ImageSearchResponse>(requestMessage);
       }
