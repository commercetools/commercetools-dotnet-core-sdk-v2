...
namespace commercetools.Ml.Client.RequestBuilders.MissingData
{
   public partial class ByProjectKeyMissingDataImagesStatusByTaskIdGet : ApiMethod<ByProjectKeyMissingDataImagesStatusByTaskIdGet> {
       ...
       public async Task<commercetools.Ml.Models.MissingData.MissingImagesTaskStatus> ExecuteAsync()
       {
          var requestMessage = Build();
          return await ApiHttpClient.ExecuteAsync<commercetools.Ml.Models.MissingData.MissingImagesTaskStatus>(requestMessage);
       }
   }
}
