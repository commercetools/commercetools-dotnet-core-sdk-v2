...
namespace commercetools.Sdk.HistoryApi.Client.RequestBuilders.ResourceType
{
    ...
    public partial class ByProjectKeyByResourceTypeGet : ApiMethod<ByProjectKeyByResourceTypeGet>, IApiMethod<ByProjectKeyByResourceTypeGet, commercetools.Sdk.HistoryApi.Models.ChangeHistories.IRecordPagedQueryResponse>
    {
        ...
        {
            return this.GetQueryParam("userIds");
        }

        public List<string> GetResourceIds()
        {
            return this.GetQueryParam("resourceIds");
        }
        ...
        public ByProjectKeyByResourceTypeGet WithUserIds(string userIds)
        {
            return this.AddQueryParam("userIds", userIds);
        }

        public ByProjectKeyByResourceTypeGet WithResourceIds(string resourceIds)
        {
            return this.AddQueryParam("resourceIds", resourceIds);
        }
        ...
        public ByProjectKeyByResourceTypeGet WithWithTotal(bool withTotal)
        {
