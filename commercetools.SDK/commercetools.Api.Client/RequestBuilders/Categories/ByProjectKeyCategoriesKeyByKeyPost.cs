...
namespace commercetools.Api.Client.RequestBuilders.Categories
{
   public partial class ByProjectKeyCategoriesKeyByKeyPost : ApiMethod<ByProjectKeyCategoriesKeyByKeyPost> {
       ...
       private commercetools.Api.Models.Categorys.CategoryUpdate CategoryUpdate;
   
       public ByProjectKeyCategoriesKeyByKeyPost(IClient apiHttpClient, ISerializerService serializerService, string projectKey, string key, commercetools.Api.Models.Categorys.CategoryUpdate categoryUpdate) {
